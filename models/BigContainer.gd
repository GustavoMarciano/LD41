...
func _on_radar_entered():
	hud.newline()
	hud.add_text("You're getting closer to  (BigContainer) ...")
	pass
func _on_player_entered():
	hud.newline()
	hud.add_text("You are in front of the (BigContainer")
	hud.newline()
	hud.add_text("Type open to open the (BigContainer)")
	pass
func _on_player_exit():
	hud.newline()
	hud.add_text("leaving (BigContainer)")
	pass